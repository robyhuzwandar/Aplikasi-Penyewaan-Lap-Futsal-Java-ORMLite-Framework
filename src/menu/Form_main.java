...
import kasir.Form_Kasir;
import pelunasan2.Form_Pelunasan;
import penyewa.Form_Penyewa;
...
public class Form_main extends javax.swing.JFrame {
    ...
    private Form_Penyewa penyewa;
    private Form_Kasir kasir;
    private Form_penyewaan item;
    private Form_PenyewannItem boking;
    private Form_AlatLap alatLap;
    private Form_penyewaan penyewaan;
    private Form_Pelunasan pembayaran;
...
//      cardlayout
        ...
        pembayaran = new Form_Pelunasan();
        panelDasar.add("pembayaran", pembayaran);

        alatLap = new Form_AlatLap();
        panelDasar.add("alatlap", alatLap);

        penyewaan = new Form_penyewaan();
        panelDasar.add("penyewaan", penyewaan);

        penyewa = new Form_Penyewa();
        panelDasar.add("penyewa", penyewa);

        kasir = new Form_Kasir();
        panelDasar.add("kasir", kasir);

        item = new Form_penyewaan();
        panelDasar.add("item", item);

        boking = new Form_PenyewannItem();
        panelDasar.add("boking", boking);
