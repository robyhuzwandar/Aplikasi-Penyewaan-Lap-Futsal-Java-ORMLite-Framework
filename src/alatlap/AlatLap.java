...
public class AlatLap {
    ...
    @ForeignCollectionField
    private ForeignCollection<Pelunasan2> pelunasan2s;
    ...
    public ForeignCollection<Pelunasan2> getPelunasan2s() {
        return pelunasan2s;
    }

    public void setPelunasan2s(ForeignCollection<Pelunasan2> pelunasan2s) {
