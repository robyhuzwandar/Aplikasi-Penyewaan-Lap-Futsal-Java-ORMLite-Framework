...
import static alatlap.Form_AlatLap.jlViewImage;
...
public class AlatLapDAOImp implements AlatlapDaoService {
    ...
    @Override
    public void vieImg(int id) {

        try {
            List<AlatLap> lista = dao.queryBuilder().where().eq("id", id).query();
//            for (AlatLap al : lista) {
//                ObjectOutputStream objectOutputStream = null;

//                ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
//                InputStream in = blob.getBinaryStream();
//                byte[] imagebyte = al.getGambar();
//                BufferedImage theImage = null;
//                try {
//                    theImage = ImageIO.read(new ByteArrayInputStream(imagebyte));
//                    jlViewImage.setIcon(new ImageIcon(theImage));
